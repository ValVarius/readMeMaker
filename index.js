...
inquirer
  .prompt([
    ...
    },
    {
      ...
      name: "table",
      message:
        "Would you like to add a table of contents? Then Enter a list of contents each separated by comma:Example(description,installation,etc)",
    },
    {
      type: "input",
      name: "description",
